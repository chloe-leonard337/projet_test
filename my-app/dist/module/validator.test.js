...
describe('validateForm', () => {
  ...
  it('should return true if all parameters are valid', () => {
    ...
    expect((0, _validator.validateForm)(age, postalCode, city, identity, email)).toBe(true);
  });

  // L'utilisateur a moins de 18 ans
  it('should throw an error if user is under 18 years old', () => {
    const age = {
      birth: new Date("01/01/2015")
    };
    const postalCode = '75001';
    const city = 'Paris';
    const identity = {
    ...
    const email = 'chloe@example.com';
    expect(() => (0, _validator.validateForm)(age, postalCode, city, identity, email)).toThrow('user should be at least 18 years old');
  });

  // L'utilisateur a exactement 18 ans
  it('should validate if user is exactly 18 years old', () => {
    const age = {
      birth: new Date(new Date().setFullYear(new Date().getFullYear() - 18))
    };
    const postalCode = '75001';
    const city = 'Paris';
    const identity = {
  ...
  it('should throw an error if postal code is invalid', () => {
    ...
    const email = 'chloe@example.com';
    expect(() => (0, _validator.validateForm)(age, postalCode, city, identity, email)).toThrow('postal code is invalid');
  });
  ...
  it('should throw an error if city is invalid', () => {
    ...
    const email = 'chloe@example.com';
    expect(() => (0, _validator.validateForm)(age, postalCode, city, identity, email)).toThrow('city is invalid');
  });
  ...
  it('should throw an error if identity is invalid', () => {
    ...
    const email = 'chloe@example.com';
    expect(() => (0, _validator.validateForm)(age, postalCode, city, identity, email)).toThrow('identity is invalid');
  });
  ...
  it('should throw an error if email is invalid', () => {
    ...
    expect(() => (0, _validator.validateForm)(age, postalCode, city, identity, email)).toThrow('email is invalid');
  });
