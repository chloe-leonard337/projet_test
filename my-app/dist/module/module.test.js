...
describe('calculateAge Unit Test Suites', () => {
  ...
  it('should return a correct age', () => {
    ...
    expect((0, _module.calculateAge)(chloe)).toEqual(21);
  });
  ...
  it('should thorw a "param p should be an object" error', () => {
    expect(() => (0, _module.calculateAge)(42)).toThrow('param p should be an object');
    expect(() => (0, _module.calculateAge)(null)).toThrow('param p should be an object');
  });

  // Paramètre birth manquant
  it('should throw a "object p should have a birth parameter" error', () => {
    const chloe = {};
    expect(() => (0, _module.calculateAge)(chloe)).toThrow('object p should have a birth parameter');
  });
  ...
  it('should throw a "birth parameter should be a Date object" error', () => {
    ...
    expect(() => (0, _module.calculateAge)(chloe)).toThrow('birth parameter should be a Date object');
  });
  ...
  it('should throw a "birth date is invalid" error', () => {
    ...
    expect(() => (0, _module.calculateAge)(chloe)).toThrow('birth date is invalid');
  });
  ...
  it('should throw a "birth date is in the future" error', () => {
    ...
    expect(() => (0, _module.calculateAge)(chloe)).toThrow('birth date is in the future');
  });

  // Exactement 20 ans
  it('should return a correct age', () => {
    expect((0, _module.calculateAge)(people20years)).toEqual(20);
  });
});
...
describe('postal code validation', () => {
  ...
  it('should return true if postal code is valid', () => {
    ...
    expect((0, _module.validatePostalCode)(postalCode)).toBe(true);
  });

  // Le code postal est invalide
  it('should return error if postal code is invalid', () => {
    const postalCode = '7500A';
    expect(() => (0, _module.validatePostalCode)(postalCode)).toThrow('postal code should be a 5-digit number');
  });
  ...
  it('should return error if postal code has less than 5 digits', () => {
    ...
    expect(() => (0, _module.validatePostalCode)(postalCode)).toThrow('postal code should have 5 digits');
  });
  ...
  it('should return error if postal code is empty', () => {
    const postalCode = '';
    expect(() => (0, _module.validatePostalCode)(postalCode)).toThrow('postal code should not be empty');
  });
});
...
describe('city validation', () => {
  ...
  it('should return true if city is valid', () => {
    const city = 'Paris';
    expect((0, _module.validateCity)(city)).toBe(true);
  });

  // La ville est invalide
  it('should return error if city is invalid', () => {
    const city = '';
    expect(() => (0, _module.validateCity)(city)).toThrow('city should not be empty');
  });
  ...
  it('should return error if city is not a string', () => {
    const city = 123;
    expect(() => (0, _module.validateCity)(city)).toThrow('param city should be a string');
  });
  ...
  it('should return false if city is composed of numbers', () => {
    const city = 'Paris123';
    expect(() => (0, _module.validateCity)(city)).toThrow('city should only contain letters and spaces');
  });
  ...
  it('should return error if city contains script tags', () => {
    ...
    expect(() => (0, _module.validateCity)(city)).toThrow('city should not contain script tags');
  });
});
...
describe('verifyIdentity Unit Test Suites', () => {
  ...
  it('should throw a "missing param identity" error', () => {
    expect(() => (0, _module.verifyIdentity)()).toThrow('missing param identity');
  });

  // Paramètre identity n'est pas un objet
  it('should throw a "param identity should be an object" error', () => {
    expect(() => (0, _module.verifyIdentity)(42)).toThrow('param identity should be an object');
    expect(() => (0, _module.verifyIdentity)(null)).toThrow('param identity should be an object');
  });
  ...
  it('should throw an error if name is empty', () => {
    ...
    expect(() => (0, _module.verifyIdentity)(identity)).toThrow('name parameter is empty');
  });

  // Paramètre name manquant
  it('should throw a "object identity should have a name parameter" error', () => {
    const identity = {};
    expect(() => (0, _module.verifyIdentity)(identity)).toThrow('object identity should have a name parameter');
  });
  ...
  it('should throw a "name parameter should be a string" error', () => {
    ...
    expect(() => (0, _module.verifyIdentity)(identity)).toThrow('name parameter should be a string');
  });
  ...
  it('should throw a "name parameter should not contain numbers or special characters" error', () => {
    ...
    expect(() => (0, _module.verifyIdentity)(identity)).toThrow('name parameter should not contain numbers or special characters');
  });
  ...
  it('should return true if name contains only valid characters', () => {
    ...
    expect((0, _module.verifyIdentity)(identity)).toBe(true);
  });
  ...
  it('should throw a "name parameter should not contain script tags" error', () => {
    ...
    expect(() => (0, _module.verifyIdentity)(identity)).toThrow('name parameter should not contain script tags');
  });
...
describe('verify Email Unit Test Suites', () => {
  ...
  it('should throw a "missing param email" error', () => {
    expect(() => (0, _module.verifyEmail)()).toThrow('missing param email');
  });

  // Paramètre email n'est pas une chaîne de caractères
  it('should throw a "param email should be a string" error', () => {
    expect(() => (0, _module.verifyEmail)(42)).toThrow('param email should be a string');
    expect(() => (0, _module.verifyEmail)(null)).toThrow('param email should be a string');
  });

  // Paramètre email n'est pas un email valide
  it('should throw a "email parameter should be a valid email address" error', () => {
    expect(() => (0, _module.verifyEmail)('invalid email')).toThrow('email parameter should be a valid email address');
  });

  // Paramètre email est un email valide
  it('should return true if email is valid', () => {
    expect((0, _module.verifyEmail)('test@example.com')).toBe(true);
  });
  ...
  it('should return true if email is valid with special characters', () => {
    expect((0, _module.verifyEmail)('test+tag@example.com')).toBe(true);
  });

  // Paramètre email est un email valide avec des sous-domaines
  it('should return true if email is valid with subdomains', () => {
    expect((0, _module.verifyEmail)('test@subdomain.example.com')).toBe(true);
  });
  it('should return error if email is invalid', () => {
    expect(() => (0, _module.verifyEmail)('invalid email')).toThrow('email parameter should be a valid email address');
  });
  it('should return error if email is empty', () => {
    expect(() => (0, _module.verifyEmail)('')).toThrow('email parameter should be a valid email address');
  });
});